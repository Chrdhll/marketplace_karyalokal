                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            <li class="nav-item"><a class="nav-link" href="{{ route('index') }}l">Beranda</a></li>
                            ...
                            <div class="col-md-3">
                                <div class="blog_info text-right">
                                    ...
                                    <ul class="blog_meta list">
                                        ...
                                        <li><a href="#">12 Dec, 2018<i class="lnr lnr-calendar-full"></i></a>
                                        </li>
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    ...
                                    <div class="blog_details">
                                        ...
                                        <a href="{{ route('single-product') }}" class="white_bg_btn">View More</a>
                                    </div>
                                </div>
                            </div>
                        </article>

                            ...
                            <article class="row blog_item">
                                <div class="col-md-3">
                                    <div class="blog_info text-right">
                                        <div class="post_tag">
                                            <a href="{{ route('public.gigs.index', ['service' => $gig->service]) }}">{{ $gig->service }}</a>
                                        </div>
                                        <ul class="blog_meta list">
                                            <li><a href="#">{{ $gig->user->name }}<i class="lnr lnr-user"></i></a>
                                            </li>
                                            <li><a href="{{ route('public.gigs.show', $gig->slug) }}">{{ $gig->created_at->format('d M, Y') }}<i
                                                        class="lnr lnr-calendar-full"></i></a></li>
                                            <li><a href="{{ route('public.gigs.show', $gig->slug) }}">{{ $gig->review_count }} Ulasan<i
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        <a href="{{ route('public.gigs.show', $gig->slug) }}">
                                            <img src="{{ $gig->cover_image_path ? Storage::url($gig->cover_image_path) : 'https://via.placeholder.com/600x350' }}"
                                                alt="{{ $gig->title }}">
                                        </a>
                                        <div class="blog_details">
                                            ...
                                            <a href="{{ route('public.gigs.show', $gig->slug) }}" class="btn btn-outline-warning" style="color: #555">Lihat
                                                Detail Jasa</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single_sidebar_widget author_widget">
                            ...
                            <p>{{ $user->freelancerProfile?->headline }}</p>
                            <p>{{ Str::limit($user->freelancerProfile?->bio, 150) }}</p>
                            <div class="br"></div>
                        </aside>
                        ...
                        <aside class="single_sidebar_widget popular_post_widget">
                            ...
                            @forelse ($popularGigs as $popGig)
                                <div class="media post_item">
                                    <img src="{{ $popGig->cover_image_path ? Storage::url($popGig->cover_image_path) : 'https://via.placeholder.com/100x70' }}"
                                        alt="post" style="width: 80px; height: 60px; object-fit: cover;">
                        ...
                        <aside class="single_sidebar_widget post_category_widget">
                            ...
                            <ul class="list cat-list">
                                @forelse ($categories as $category)
                                    <li>
                                        <a href="{{ route('public.gigs.index', ['category' => $gig->category->slug]) }}"
...
@push('styles')
    <style>
        @media (max-width: 991.98px) {
            .blog_area .blog_left_sidebar .blog_item .blog_info {
                /* Jurus 1: Paksa seluruh blok ini untuk pindah ke kanan */
                margin-left: auto;
                margin-right: 0;
                /* Pastikan tidak ada margin kanan yang aneh */
                width: 100%;
                /* Ambil lebar penuh yang tersedia */

                /* Jurus 2: Pastikan teks DI DALAM blok juga rata kanan */
                text-align: left !important;

                /* Jurus 3: Atur ulang padding agar rapi */
                padding: 15px;
            }

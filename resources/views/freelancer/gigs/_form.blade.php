...
<div class="row">
    ...
    <div class="col-md-12 form-group">
        ...
        <select name="category_id" id="category_id" class="form-control tom-select-custom" required>
    ...
    <div class="col-md-6 form-group">
        ...
        <input type="text" id="estimated_time" name="estimated_time"
            class="form-control @error('estimated_time') is-invalid @enderror" placeholder="Contoh: 3 Hari, 1 Minggu"
            value="{{ old('estimated_time', $gig->estimated_time ?? '') }}" required>
    ...
    <div class="col-md-12 form-group">
        ...
        @if (isset($gig) && $gig->cover_image_path)
            <div class="mt-2">
                <p>Gambar saat ini:</p>
                <img src="{{ Storage::url($gig->cover_image_path) }}" alt="Cover Image"
